...
ActiveRecord::Schema[7.0].define(version: 2023_01_02_134206) do
  ...
  create_table "return_accepted_notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["borrower_id"], name: "index_return_accepted_notifications_on_borrower_id"
  ...
  create_table "return_declined_notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["borrower_id"], name: "index_return_declined_notifications_on_borrower_id"
  ...
  add_foreign_key "return_accepted_notifications", "users", column: "borrower_id"
  add_foreign_key "return_declined_notifications", "items"
  add_foreign_key "return_declined_notifications", "users", column: "borrower_id"
